...
class EdgeTPUModel:
    ...
    def __init__(self, model_file, names_file, conf_thresh=0.25, iou_thresh=0.25, filter_classes=None, agnostic_nms=False, max_det=1000, v8=True):
        """
    ...
    def make_interpreter(self):
        ...
        self.interpreter = Interpreter(model_path=self.model_file, experimental_delegates=[load_delegate('libedgetpu.so.1')])
